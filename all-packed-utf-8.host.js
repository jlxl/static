...
(function(a) {
    ...
    TR.prototype = {
        ...
        _updateTips: function(e, d, c) {
            ...
            /**
             * 这是回调， 没处理过10的code。我得先找出来接口到底是啥。
             * data 估计是个列表， 或者就是个map， f是key， 原词， g是难度
             * 猜测如此，明儿写个lambda function试试， 可以的话就这样吧
             *  {
             *     errorCode:0,
             *     data:{}
             *
...
(function(h) {
    ...
    a.processXmlTransData = function(r) {
        ...
        var o =
            "https://fanyi.youdao.com/translate?i=" +
    ...
    a.processXmlDictData = function(D) {
        ...
        if (q.length + z.length > 0 && v) {
            A =
                ...
                j(
                    "https://dict.youdao.com/speech?audio=" + v,
                    "test",
                    "CLICK",
                    "dictcn_speech"
                ) +
